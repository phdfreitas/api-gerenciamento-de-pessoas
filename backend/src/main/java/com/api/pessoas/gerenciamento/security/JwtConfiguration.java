...
public class JwtConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        ...
        http
            ...
            .antMatchers(HttpMethod.POST, "/pessoas/adicionarNovoEndereco/{id}").permitAll()
            .antMatchers(HttpMethod.GET, "/pessoas/relatorio").permitAll()
            .antMatchers(HttpMethod.GET, "/pessoas/listarTodas").permitAll()
            .antMatchers(HttpMethod.GET, "/pessoas/relatorioEndereco/{id}").permitAll()
            .antMatchers(HttpMethod.GET, "/pessoas/enderecos/{id}").permitAll()
